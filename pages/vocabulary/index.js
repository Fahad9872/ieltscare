...
const vocabularySections = [
  {
    ...
    icon: <FaSearch />,
    description: "Learn common words used in everyday conversations and their meanings.",
  ...
  },
  {
    ...
    icon: <FaBook />,
    description: "Explore academic words used in professional, educational, and formal settings.",
  ...
  },
  {
    ...
    icon: <FaQuoteRight />,
    description: "Master common idioms and expressions used by native speakers.",
    ...
    <div className="md:max-w-[1400px] mx-auto bg-gray-50">
      ...
      <div className="text-center py-16 px-6 bg-blue-50">
        ...
        <p className="text-lg mt-4 max-w-3xl mx-auto">
          This guide will help you strengthen your vocabulary through various themes, from everyday words to academic terms and idiomatic expressions.
        </p>
      </div>

      {/* What is Vocabulary Section */}
      <section className="py-16 bg-gradient-to-b from-white to-gray-100 text-center">
        <h2 className="text-3xl font-semibold text-gray-800 mb-6">What is Vocabulary? 🧐</h2>
        <p className="text-lg text-gray-700 mb-8 max-w-3xl mx-auto">
          Vocabulary refers to the words we use to communicate, whether in speaking, writing, or reading. Each section focuses on a different area of vocabulary mastery.
        </p>
      </section>
      ...
      <section className="py-16 bg-gradient-to-b from-gray-200 to-white">
        <h2 className="text-3xl font-semibold text-gray-800 mb-8">How to Improve Your Vocabulary 📝</h2>
        <div className="text-lg text-gray-700">
          <p className="mb-4">Boost your vocabulary by adopting these proven techniques:</p>
            ...
            {[
              ...
              <div key={index} className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600 mt-2">Detailed explanation of how this strategy will improve your vocabulary and language skills.</p>
                </div>
              </div>
            ))}
          </div>
