...
const readingSections = [
  {
    ...
    icon: <FaSearch />,
    description: "You’ll read dialogues or short texts related to everyday situations like travel or booking appointments.",
    image: "/section1.jpg",
    content: [
  ...
  },
  {
    ...
    icon: <FaBook />,
    description: "You’ll read informative texts on topics such as news, instructions, or general information.",
    image: "/section2.jpg",
    content: [
  ...
  },
  {
    ...
    description: "You’ll read texts that include multiple viewpoints or complex discussions, such as reports or opinion articles.",
    image: "/section3.jpg",
    content: [
  ...
  },
  {
    ...
    icon: <FaQuoteRight />,
    description: "You’ll read detailed academic texts on topics like science, history, or culture.",
    image: "/section4.jpg",
    content: [
    ...
    <div className="md:max-w-[1400px] mx-auto bg-gray-50">
      ...
      <h1 className="text-4xl font-extrabold tracking-wide drop-shadow-lg">
        ...
        <p className="text-lg mt-4 max-w-3xl mx-auto">
          This guide helps you improve your reading comprehension skills across various types of texts, from casual conversations to academic articles.
        </p>
      </div>

      {/* What is Reading Section */}
      <section className="py-16 bg-gradient-to-b from-white to-gray-100 text-center">
        <h2 className="text-3xl font-semibold text-gray-800 mb-6">What is Reading Comprehension? 📚</h2>
        <p className="text-lg text-gray-700 mb-8 max-w-3xl mx-auto">
          Reading comprehension is essential to understanding written texts across different contexts. Let’s explore each of the four sections you’ll encounter:
        </p>
      </section>
      ...
      <div className=" grid grid-cols-1 md:grid-cols-4  gap-12">
          {readingSections.map((section) => (
            ...
            >
              ...
              <h3 className="text-xl font-bold text-gray-800 mt-6">{section.name}</h3>
      ...
      <section className="py-16 bg-gray-100">
        <h2 className="text-3xl font-semibold text-gray-800 mb-8">Deep Dive into {selectedSection.name}</h2>
        <div className="">
      ...
      <section className="py-16 bg-gradient-to-b from-gray-200 to-white">
        <h2 className="text-3xl font-semibold text-gray-800 mb-8 ">How to Improve Your Reading Skills 📈</h2>
        <div className=" text-lg text-gray-700">
          <p className="mb-4">Enhance your reading skills and boost your score with these refined tips:</p>
            ...
            {[
              ...
              <div key={index} className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600 mt-2">Detailed explanation of how this strategy will improve your reading skills and understanding.</p>
                </div>
              </div>
            ))}
          </div>
