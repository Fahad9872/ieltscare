...
const Vision = () => {
  return (
    <section className=" px-6 py-10 lg:pt-16 md:max-w-[1100px] mx-auto">
      <h1 className="text-[#f2496a] md:text-center font-bold text-4xl  lg:text-5xl mb-6">
        Our Vision
      </h1>
      <h2 className=" font-normal text-xl text-[#787878] text-center">
        We aim to empower individuals to excel in the IELTS exam and achieve
      ...
      <div className="grid grid-cols-6 md:gap-x-8">
        <div className="md:col-span-2  my-8 col-span-6 relative  group cursor-pointer">
          ...
          >
            <div
              style={{
                ...
                background:
                  "linear-gradient(0deg, #f2496a 21.35%, rgba(254, 0, 0, 0) 136.54%)",
              }}
              ...
              <div className="absolute ml-auto mr-auto left-0 right-0 bottom-10 text-center text-white">
                <div className="px-5">
                  ...
                  <p className="text-center text-lg hidden group-hover:block  mt-5 ">
                    Gain access to top-tier IELTS coaching, strategies, and
                    resources to achieve your desired band score.
                  </p>
                </div>
              </div>
            </div>
            <div className="bg-[#f2496a] py-[5px] w-3/4  absolute -bottom-1 left-0 right-0 mx-auto rounded-2xl"></div>
          </div>
          <div
            style={{
          ...
          >
            <div className="border-[#f2496a] absolute  px-5  border-l-8 mt-auto mb-auto top-0 bottom-0 -left-1 rounded h-[250px]"></div>
            <div
              style={{
                content: "",
                display: "block",
            ...
            <div className="">
              <div className="absolute ml-auto mr-auto left-0 right-0 bottom-10 text-center text-white">
                <div className="px-5">
                  ...
                  <p className="text-center text-lg hidden group-hover:block  mt-5 ">
                    Customized IELTS study plans tailored to your strengths and
                    weaknesses for maximum improvement.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="">
              <div className="absolute ml-auto mr-auto left-0 right-0 bottom-10 text-center text-white">
                <div className="px-5">
                  ...
                  <p className="text-center text-lg hidden group-hover:block  mt-5 ">
                    IELTS success can unlock opportunities for studying,
                    working, and settling abroad—let’s make it happen!
                  </p>
                </div>
              </div>
            </div>
            <div className="bg-[#f2496a] py-[5px] w-3/4 mx-auto absolute -bottom-1 left-0 right-0 mx-auto rounded-2xl"></div>
          </div>
          ...
          >
            ...
            <div className="absolute ml-auto mr-auto group-hover:top-[35%]  left-0 right-0 bottom-10 text-center text-white my-auto">
              <div className="px-5">
                ...
                <p className="text-center text-lg hidden group-hover:block  mt-5 ">
                  IELTS success can unlock opportunities for studying, working,
                  and settling abroad—let’s make it happen!
                </p>
              </div>
            </div>
          </div>
